...
var Entity = global.Draft.Entity;
...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.LINK, { href: 'href', rel: 'rel', target: 'target', title: 'title', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.IMAGE, { src: 'src', height: 'height', width: 'width', alt: 'alt', className: 'class' }), _ENTITY_ATTR_MAP);
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref2) {
        ...
        var entity = entityKey ? Entity.get(entityKey) : null;
